<template>
  <el-container>
    <el-header class="el-header">
      <div>
        <span class="el-icon-lock" @click="logout()"> 退出登录 </span>
      ...
      <el-aside width="200px" class="el-aside">
        <el-menu :default-active="menuActivateIndex" mode="vertical" router>
          <el-menu-item index="1" route="/MainGround"
            ><span @click="changeToYonghu"
              ><i class="el-icon-user"></i>用户管理</span
            ></el-menu-item
          >
          <el-menu-item index="2" route="/Tiezi"
            ><i class="el-icon-edit"></i>帖子管理</el-menu-item
          >
          <el-menu-item index="3" route="/Dangan"
            ><span @click="changeToDangan"
              ><i class="el-icon-menu"></i>档案管理</span
            ></el-menu-item
          >
          <el-menu-item index="4" route="/Qiuzhu"
            ><span @click="changeToQiuzhu"
              ><i class="el-icon-help"></i>求助管理</span
            ></el-menu-item
          >
        </el-menu>
      </el-aside>
            ...
            <el-card class="box-card" v-for="post in unCheckedPosts">
              ...
              <div
                v-if="
                  post.pics != None &&
                  post.pics.length != 0 &&
                  (post.pics.length != 1 || post.pics[0].length != 0)
                "
              >
                <div
                  class="block"
          ...
          <el-collapse-item title="已审核帖子" name="2">
            <el-card class="box-card" v-for="post in checkedPosts">
              ...
              >
                <div
                  class="block"
                  style="display: inline-block; margin: 10 10 10 10"
                  v-for="img in post.pics"
                >
                  <el-image
                    style="width: 100px; height: 100px"
